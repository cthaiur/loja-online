...
$(document).ready(function() {
    ...
    if (typeof href !== 'undefined') {
        $('navigation').find('[href="'+href+'"]').addClass('btn-default');
    }
    
    $(".adianti-submenu a" ).click(function() 
    {
        $('.adianti-submenu').removeClass('show');
    });
});

function __adianti_show_popover(element, title, message, placement)
{
