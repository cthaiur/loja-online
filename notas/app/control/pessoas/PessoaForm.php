...
class PessoaForm extends TWindow
{
    ...
    public function __construct( $param )
    {
        ...
        $cidade_id = new TDBCombo('cidade_id', 'notas', 'Cidade', 'id', 'nome', 'nome', $filter);
        $estado_id = new TDBCombo('estado_id', 'notas', 'Estado', 'id', '{nome} ({uf})');
    ...
    public function onSave( $param )
    {
        try
        {
            TTransaction::open('notas'); // open a transaction
    ...
    public static function onChangeEstado($param)
    {
        try
        {
            ...
            if (!empty($param['estado_id']))
            {
                ...
                TDBCombo::reloadFromModel('form_Pessoa', 'cidade_id', 'notas', 'Cidade', 'id', '{nome} ({id})', 'nome', $criteria, TRUE);
            }
            else
            {
