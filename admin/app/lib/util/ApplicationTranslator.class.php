...
class ApplicationTranslator
{
    ...
    private function __construct()
    {
        ...
        $this->messages['en'][] = 'Log in';
        $this->messages['en'][] = 'Clear';
        $this->messages['en'][] = 'Blocks';
        $this->messages['en'][] = 'Block';
        $this->messages['en'][] = 'Key';
        $this->messages['en'][] = 'Subtitle';
        $this->messages['en'][] = 'Tags';
        $this->messages['en'][] = 'Image';
        $this->messages['en'][] = 'Position';
        $this->messages['en'][] = 'Template';
        $this->messages['en'][] = 'Code';
        $this->messages['en'][] = 'Author';
        $this->messages['en'][] = 'Media';
        $this->messages['en'][] = 'Medias';
        $this->messages['en'][] = 'Icon';
        $this->messages['en'][] = 'Show menu';
        $this->messages['en'][] = 'Menu';
        $this->messages['en'][] = 'Variable';
        $this->messages['en'][] = 'Variables';
        $this->messages['en'][] = 'Value';
        $this->messages['en'][] = 'Clone';
        $this->messages['en'][] = 'Return';
        $this->messages['en'][] = 'Link';
        ...
        $this->messages['pt'][] = 'Entrar';
        $this->messages['pt'][] = 'Limpar';
        $this->messages['pt'][] = 'Blocos';
        $this->messages['pt'][] = 'Bloco';
        $this->messages['pt'][] = 'Chave';
        $this->messages['pt'][] = 'Subtítulo';
        $this->messages['pt'][] = 'Tags';
        $this->messages['pt'][] = 'Imagem';
        $this->messages['pt'][] = 'Posição';
        $this->messages['pt'][] = 'Template';
        $this->messages['pt'][] = 'Código';
        $this->messages['pt'][] = 'Autor';
        $this->messages['pt'][] = 'Mídia';
        $this->messages['pt'][] = 'Mídias';
        $this->messages['pt'][] = 'Ícone';
        $this->messages['pt'][] = 'Exibir menu';
        $this->messages['pt'][] = 'Menu';
        $this->messages['pt'][] = 'Variável';
        $this->messages['pt'][] = 'Variáveis';
        $this->messages['pt'][] = 'Valor';
        $this->messages['pt'][] = 'Clonar';
        $this->messages['pt'][] = 'Voltar';
        $this->messages['pt'][] = 'Link';
